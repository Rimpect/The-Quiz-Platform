...
export function RulesInfoModal({ onClose }) {
  return (
    <ModalInfo title="Правила прохождения квиза" onClose={onClose}>
      <p>
      ...
      <ul className={styles.modalList}>
        ...
        <li>
          <strong> 3 нарушения — блокировка.</strong> После трёх нарушений квиз
          автоматически завершится.
        </li>
        <li>
          <strong> Командный режим.</strong> Решение принимает капитан команды;
          остальные участники голосуют за варианты.
        </li>
      </ul>
    </ModalInfo>
  )
